...
<body class="merced-page">
    ...
    <main class="merced-main merced-main--center">
        <div class="merced-error-box">
            <div class="merced-error-code">500</div>
            <i class="bi bi-exclamation-triangle-fill" style="font-size:3rem;color:var(--merced-red);display:block;margin:12px 0"></i>
            <h2 class="fw-bold mb-2">Error del Servidor</h2>
            <p class="text-muted mb-4">Ocurrió un error inesperado. Contacta al administrador.</p>
            <% if (exception != null) { %>
                <div class="alert alert-warning text-start" style="font-size:.8rem">
